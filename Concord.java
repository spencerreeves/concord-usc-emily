...
public class Concord {
   ...
   public void printSorted(PrintStream out) {
      ArrayList<Integer> occurrences = new ArrayList<Integer>(concord.values());
      Collections.sort(concord, new OccurrenceComparator());
      print(out);
   }
...
private class OccurrenceComparator implements Comparator<Concord>
{
   public int compare(Concord a, Concord b)
   {
